...
scoreSeq = cvSeq(i = i, dat = dat, initialGroups = initialGroups, phalanxes)
scorePar = cvPar(i = i, dat = dat, initialGroups = initialGroups, phalanxes)
print(scoreSeq == scorePar) #[1] FALSE  TRUE  TRUE
